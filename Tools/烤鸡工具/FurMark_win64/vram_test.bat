...
echo 4.  start a 10GB VRAM test
echo 5.  start a 12GB VRAM test
echo 6.  start a 16GB VRAM test
echo 7.  start a 20GB VRAM test
echo 8.  start a 24GB VRAM test
echo 9.  start a 32GB VRAM test
echo 10. Exit
...
:task4
echo start a 10GB VRAM test
furmark --demo furmark-gl --width 1920 --height 1080 --furmark-vram-test-gb 10
pause
goto menu
...
:task9
echo start a 32GB VRAM test
furmark --demo furmark-gl --width 1920 --height 1080 --furmark-vram-test-gb 32
pause
goto menu
