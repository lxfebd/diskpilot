...
fn load_conda() -> diskpilot_scaffold::Scaffold {
...
fn conda_globs_are_safe() {
    ...
    let positives: &[(&str, &str)] = &[
        ...
        // 其他合法安装位置（ProgramData / 盘符根 / /opt）
        ("tarballs", "C:/ProgramData/miniconda3/pkgs/cache"),
        ("tarballs", "D:/miniconda3/pkgs/cache"),
        ("tarballs", "/opt/miniconda3/pkgs/cache"),
        ("unused-packages", "/opt/miniconda3/pkgs/numpy-1.24"),
        ("envs-stale", "D:/anaconda3/envs/old"),
    ];
    ...
    let red_lines: &[&str] = &[
        ...
        "C:/Users/test/Desktop/anaconda3/pkgs/numpy-1.24",
        "C:/Users/test/Documents/miniconda3/envs/tf",
        "C:/Users/test/my-conda-experiments/pkgs/x",
        // 不在枚举位置：其他用户 / ProgramData 下 .conda / /opt 嵌套 / 盘符嵌套
        "C:/Users/other/anaconda3/pkgs/x",
        "C:/ProgramData/.conda/pkgs/cache",
        "/opt/myapps/miniconda3/pkgs/x",
        "D:/tools/miniconda3/pkgs/x",
    ];
